  ...
  return (
    <div className='header min-h-[34vw] rounded-3xl flex items-center px-5 md:px-20 py-10 my-10 '>
      <div className='flex flex-col  gap-4 md:gap-10 items-start justify-end header-content ' >
        ...
        <p className='max-w-xl text-sm text-slate-600'>Choose from diverse menu featuring  array of dishes crafted  with finest ingridents and culinary epxpertise.Our mission is to satisfy your craving and elevate your dining experince ,one delicious meal at a time </p>
